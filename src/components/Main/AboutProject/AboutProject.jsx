    ...
    <section className="project" id="project">
      ...
      <ul className="project__description">
        <li className="project__description-item">
          <h3 className="project__brief">Дипломный проект включал 5 этапов</h3>
      ...
      <ul className="project__graph">
        <li className="project__graph-item">
          <p className="project__graph-title project__graph-title--color-green">
            1 неделя
          </p>
          <p className="project__graph-description">Back-end</p>
        </li>
        <li className="project__graph-item">
          <p className="project__graph-title project__graph-title--color-black">
            4 недели
          </p>
